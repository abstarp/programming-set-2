...
def shift_letter(letter, shift):
    ...
    *Note: the single underscore `_` is used to acknowledge the presence
    ...
    ''' 
    - how to communicate the alphabet
    - how to wrap around if it reaches the end
    '''
def shift_letter(letter, shift):
    # need list
    ...
    new_index = (current_index + shift) % 26 #wrap around
...
def caesar_cipher(message, shift):
    ...
    for char in message:
        if char == " ":
            ...
            char_index = alphabet.index(char) #current position
            new_index = (char_index + shift) % 26 #new position, %26 will allow to wrap around
...
def shift_by_letter(letter,letter_shift):
    ...
    if letter == " ":
        return " "
    shift_value = letter_to_num[letter_shift] #value of shift letter
    OG_value = letter_to_num[letter] #value of original letter

    shifted_value = (shift_value + OG_value) % 26

    for key, value in letter_to_num.items(): #find the letter matching the shifted value
